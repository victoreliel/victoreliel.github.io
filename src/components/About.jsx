...
import {
  AiOutlineCloudDownload, AiFillGithub, AiFillLinkedin, AiOutlineWhatsApp, AiOutlineLink,
} from 'react-icons/ai';
...
export default function About() {
  return (
    <div id="about" className="p-8 pt-24 border border-gray-300 rounded-lg mx-28">
